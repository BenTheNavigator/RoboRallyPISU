...
/**
 * The class space revolves around the specific area that an object/subject can stand on
 *
...
public class Space extends Subject {
    ...
    /**
     * The board associated with these spaces
     */
    ...
    /**
     * The player that may or may not be on the space
     */
     ...
     * @param board the board where the space is
    ...
    /**
     * A getmethod for the player on the space
     * @return either the player or null if no player
     */
    ...
    /**
     * A method to set the player on the space
    ...
    /**
     * A method to notify the view of change
     */
    void playerChanged() {
